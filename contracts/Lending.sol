...
contract Lending {
    ...
    Accounts acc = Accounts(0x9C9fF5DE0968dF850905E74bAA6a17FED1Ba042a);
    ...
    function grantLoan(uint appId) public payable {
        ...
        require(hasOngoingInvestment[msg.sender] == false,"There is a on going investment");

        // Take from sender and give to reciever
        // acc.viewBalance(msg.sender) -= applications[appId].credit_amount;
        // locker +=  applications[appId].credit_amount;
        uint creditamount = applications[appId].credit_amount;
        acc.transfer(msg.sender,locker,creditamount);
